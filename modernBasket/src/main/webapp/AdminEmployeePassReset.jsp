...
<body>
	...
	%>
	<form action="EmployeePassReset.do" method="post" name="frm">
		<div class="myContainer1">
			<div class="myTextHeadings" style="justify-content: center;">Password reset</div>
			<br> <input type="text" class="text1" value="<%=request.getParameter("uname")%>" name="uname" id="uname"  ><br>
			...
			<div class="myContainer2">
				<input type="submit" class="btnGreen" Value="Reset Password" id="passResetClick1"> 
